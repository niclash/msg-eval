...
Kafka has practical limits of "thousands of topics", which may start to become a problem in large systems with a lot of entity types and messaging needs. 

Pulsar is said to be able to handle millions of topics. I also personally checked claim with people inside TenCent, one of the largest Pulsar deployments, and yes they have more topics than they care to count, including running financial transactions (WeChat Pay) over Pulsar.
